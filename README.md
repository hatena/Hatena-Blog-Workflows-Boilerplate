...
- `workflow_sync.sh`を実行してください
- ※手元にない場合は[こちらのファイル](https://github.com/hatena/Hatena-Blog-Workflows-Boilerplate/blob/6e91a9e7afc6800b98fe0934869c2c2e0b758998/workflow_sync.sh)を自身のリポジトリに追加してください

```bash
# root ディレクトリで実行する
bash workflow_sync.sh
```

- `.github/workflow`配下のファイルが追加＆更新された場合は取り込むことができます
